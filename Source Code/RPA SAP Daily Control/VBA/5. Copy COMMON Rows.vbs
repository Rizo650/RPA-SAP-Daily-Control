Sub CopyCOMMONRows()
    ...
    Set wsTarget = ThisWorkbook.Sheets("COMMON")  ' Ganti dengan nama sheet target
    ...
    ' Tentukan baris pertama yang kosong di sheet COMMON
    ...
    For i = 2 To lastRow
        ...
        ' Cek apakah nilai di kolom "Document Header Text" mengandung "CD C"
        If InStr(headerValue, "CD C") > 0 Then
