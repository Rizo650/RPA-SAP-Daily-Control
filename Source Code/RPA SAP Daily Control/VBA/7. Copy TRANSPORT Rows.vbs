Sub CopyTRANSPORTRows()
    ...
    Set wsTarget = ThisWorkbook.Sheets("TRANSPORT")  ' Ganti dengan nama sheet target
    ...
    ' Tentukan baris pertama yang kosong di sheet TRANSPORT
    ...
    For i = 2 To lastRow
        ...
        ' Cek apakah nilai di kolom "Document Header Text" mengandung "Tran"
        If InStr(headerValue, "Tran") > 0 Then
