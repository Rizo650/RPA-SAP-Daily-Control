Sub CopyPDDNRows()
    ...
    Set wsTarget = ThisWorkbook.Sheets("PDDN")  ' Ganti dengan nama sheet target
    ...
    ' Tentukan baris pertama yang kosong di sheet PDDN
    ...
    For i = 2 To lastRow
        ...
        ' Cek apakah nilai di kolom "Document Header Text" mengandung "PDDN"
        If InStr(headerValue, "PDDN") > 0 Then
