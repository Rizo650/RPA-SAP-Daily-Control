Sub CopyMEDICALRows()
    ...
    Set wsTarget = ThisWorkbook.Sheets("MEDICAL") ' Ganti dengan nama sheet target
    ...
    ' Tentukan baris pertama yang kosong di sheet MEDICAL
    ...
    For i = 2 To lastRow
        ...
        ' Cek apakah nilai di kolom "Document Header Text" mengandung "CD M"
        If InStr(headerValue, "CD M") > 0 Then
